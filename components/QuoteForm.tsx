...
export default function QuoteForm({ t }: { t: Dictionary["forms"]["quote"] }) {
    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="grid gap-5 sm:grid-cols-2">
        <div>
          ...
          <input id="phone" name="phone" type="tel" className={inputCls} placeholder="+20 1X XXX XXXX" dir="ltr" />
        </div>
        <div>
      ...
      <div className="grid gap-5 sm:grid-cols-2">
        <div>
          ...
          <select id="source_language" name="source_language" className={inputCls} defaultValue={t.langOptions[0]}>
            {t.langOptions.map((o) => (
              <option key={o}>{o}</option>
            ))}
          </select>
        ...
        <div>
          ...
          <select id="target_language" name="target_language" className={inputCls} defaultValue={t.langOptions[1]}>
            {t.langOptions.map((o) => (
              <option key={o}>{o}</option>
            ))}
          </select>
      ...
      <div>
        ...
        <textarea id="details" name="details" rows={4} className={inputCls} placeholder={t.detailsPlaceholder} />
      </div>
